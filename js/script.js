...
var aggiungiNome = prompt('Inserisci nome'); 
var aggiungiCognome = prompt('Inserisci cognome'); 
var aggiungiEta = parseInt(prompt('Inserisci eta'));

var nuovoOggettoStudente = {
    nome: aggiungiNome,
    cognome: aggiungiCognome,
    eta: aggiungiEta
}
